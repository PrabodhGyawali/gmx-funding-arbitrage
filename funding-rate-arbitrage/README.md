...
A delta-neutral funding rate arbitrage bot targeting DEX-DEX pairs (e.g., GMX on Arbitrum, Synthetix v3 on Base).

## Quick Start
1. Clone: `git clone https://github.com/50shadesofgwei/funding-rate-arbitrage.git`
2. Install: `pip install -r requirements.txt && pip install -e .`
3. Configure: Copy `.env.example` to `.env` and fill in your keys.
4. Run: `project-run-demo`
...
## Documentation
See [docs/index.md](docs/index.md) for detailed guides on installation, usage, and contributing.

## Contributions
Join our [Telegram](https://t.me/+ualID7ueKuJjMWJk) to collaborate!
